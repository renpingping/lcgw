...
function initArray(){
  ...
  var d=new initArray(
   ...
   "星期五",
   "星期六");
document.getElementById("datetime").innerText=today.getFullYear()+"年"+(today.getMonth()+1)+"月"+today.getDate()+"日 "+d[today.getDay()+1];
calendar = new Date();
...
if (yy<100) yy="19"+yy;
function showCal(){
document.getElementById("datetime").innerText=document.getElementById("datetime").innerText+" "+GetLunarDay(yy,mm,dd,ww,ss);
...
>>>>>>> 91a53dbac69c2cea09f1058e340e7a7723358bbb
showCal();